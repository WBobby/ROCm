...
$(call adddep,composable_kernel,lightning hipcc hip_on_rocclr)
...
$(call adddep,hipsolver,hip_on_rocclr rocblas rocsolver rocsparse lightning hipcc)
$(call adddep,hipsparse,hip_on_rocclr rocsparse lightning hipcc)
$(call adddep,hipsparselt,hip_on_rocclr hipsparse lightning hipcc)
...
$(call adddep,rccl,hip_on_rocclr hsa lightning hipcc rocm_smi_lib)
...
$(call adddep,rocfft,hip_on_rocclr rocrand hiprand lightning hipcc)
$(call adddep,rocmvalidationsuite,hip_on_rocclr hsa rocblas rocm-core lightning hipcc)
...
$(call adddep,rocwmma,hip_on_rocclr rocblas rocm_smi_lib lightning hipcc)
